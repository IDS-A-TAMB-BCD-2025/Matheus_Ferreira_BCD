CREATE DATABASE IF NOT EXISTS BD_SUPERMERCADO_2A;
USE BD_SUPERMERCADO_2A;
CREATE TABLE IF NOT EXISTS SUPERMERCADO_2A(
...
CREATE TABLE IF NOT EXISTS SUPERMERCADO_PRODUTO(
    ...
    FK_SUPERMERCADO_2A_CNPJ VARCHAR(20)NOT NULL,
    FOREIGN KEY (FK_SUPERMERCADO_2A_CNPJ) REFERENCES SUPERMERCADO_2A(CNPJ),
...
-- ALTERAR TABELA SUPERMERCADO_2A, MUDAR COLUNA TELEFONE
ALTER TABLE SUPERMERCADO_2A
CHANGE COLUMN TELEFONE TELEFONE_SUPERMERCADO VARCHAR(15);
-- ALTERAR TABELA SUPERMERCADO_2A, MODIFICAR COLUNA LOGRADOURO
ALTER TABLE SUPERMERCADO_2A
MODIFY COLUMN LOGRADOURO VARCHAR(500);
-- ALTERAR TABELA CONSUMIDOR, APAGAR COLUNA EMAIL
ALTER TABLE CONSUMIDOR
DROP COLUMN EMAIL;
-- APAGAR TABELA FUNCIONÁRIO
DROP TABLE FUNCIONARIO;
-- APAGAR O BANCO DE DADOS
DROP DATABASE BD_SUPERMERCADO_2A;